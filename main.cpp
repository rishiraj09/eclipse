...
void details(){
	...
	setFont(GLUT_BITMAP_HELVETICA_18);
	glColor3f(1.0,1.0,1.0);
	drawstring(5.0,7.0,0.0,"GOGTE INSTITUE OF TECHNOLOGY");
	drawstring(1.0,6.0,0.0,"   DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING");
	drawstring(6.0,4.0,0.0,"A MINI PROJECT ON");
	drawstring(3.0,3.0,0.0,"           SOLAR AND LUNAR  ECLIPSES");
	drawstring(-2.0,-2.0,0.0,"           BY ");
	drawstring(-4.0,-3.0,0.0,"ABHISHEK M PATIL : 2GI14CS006");
	drawstring(-4.0,-4.0,0.0,"SALAM RISHRIAJ SINGH  : 2GI14CS123");
	drawstring(19.0,-2.0,0.0,"GUIDE ");
	drawstring(16.0,-3.0,0.0,"           PROF.S R DHOTRE");
	glFlush();
	for(int i=0;i<300;i++)nameDelay();
}
